...
export const Input = (props: PrimitiveProps<"input", InputProps, "children">) => {
  ...
  return (
    <div
      className={tx(
        "relative inline-flex items-center rounded-md border transition-colors",
        "focus-within:border-bg-primary-emphasis focus-within:outline-bg-primary-emphasis focus-within:outline-1",
        fullWidth && "w-full",
