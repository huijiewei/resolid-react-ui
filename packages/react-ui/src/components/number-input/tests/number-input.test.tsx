...
describe("NumberInput", () => {
  ...
  test("should handle wheel event when allowMouseWheel is true", async () => {
  ...
  test("should clamp value on blur", async () => {
  ...
  test("should handle custom format and parse functions", async () => {
    render(
      <NumberInput
  ...
  test("should increment value by step when using increment button", async () => {
