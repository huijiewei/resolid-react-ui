...
export default function App() {
  ...
  return (
    <Accordion
      defaultValue={["what"]}
      className={"border-bd-normal bg-bg-normal w-80 rounded-md border"}
    >
...
export default function App() {
  ...
  return (
    <Accordion
      ...
      className={"border-bd-normal bg-bg-normal h-50 w-fit rounded-md border"}
    >
      {accordionItems.map((item) => (
        <AccordionItem
          key={item.value}
          value={item.value}
          className={"not-last:border-e border-bd-normal group flex flex-row"}
        >
          <AccordionHeader
            className={"border-bd-subtle bg-bg-subtlest/30 -me-px border-e font-medium"}
          >
            <AccordionTrigger
              className={
                "group h-full items-start justify-between break-all p-1 text-left leading-none"
              }
            >
