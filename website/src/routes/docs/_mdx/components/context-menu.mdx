...
- `ContextMenuGroupLabel`: 用于渲染标签。使用方向键无法聚焦。
    ...
    <div className={"flex flex-row justify-center gap-3"}>
      <ContextMenu>
        ...
        <ContextMenuContent className={"text-sm"}>
          ...
          <ContextMenuSeparator />
          <ContextMenu>
            <ContextMenuSubTrigger label={"Tools"}>
              更多工具
            </ContextMenuSubTrigger>
            <ContextMenuContent className={"text-sm"}>
      ...
      <ContextMenu>
        ...
        <ContextMenuContent className={"text-sm"}>
          ...
          >
            ...
            显示书签栏
            <div className="text-fg-subtle ml-auto pl-5 text-xs tracking-widest">
              ⌘+B
            </div>
          </ContextMenuCheckboxItem>
          <ContextMenuCheckboxItem
          ...
          <ContextMenuRadioGroup value={account} onChange={setAccount}>
            <ContextMenuGroupLabel>账号</ContextMenuGroupLabel>
