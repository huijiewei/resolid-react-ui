...
对话框默认的样式并不是很多，你可以通过 `DialogContent`、`DialogTitle` 和 `DialogDescription` 的 `className` 自定义对话框的样式。
  ...
  return (
    <div className={"flex flex-row gap-3"}>
      <Dialog>
        ...
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
            ...
            <div className={"flex justify-end gap-4 p-4 pt-1"}>
              <DialogClose color={"neutral"} variant={"soft"} as={Button}>
                取消
              </DialogClose>
  ...
  return (
    <div className={"flex flex-row gap-3"}>
      <Dialog placement={"top"}>
        <DialogTrigger as={Button}>打开对话框(顶部)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
      ...
      <Dialog placement={"center"}>
        <DialogTrigger as={Button}>打开对话框(中间)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
      ...
      <Dialog placement={"bottom"}>
        <DialogTrigger as={Button}>打开对话框(底部)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
  ...
  return (
    <div className={"flex flex-row gap-3"}>
      <Dialog>
        ...
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-25">
            <DialogClose
              className={"absolute end-2 top-2 p-1"}
              as={CloseButton}
            />
            ...
            <div className={"flex justify-end gap-4 p-4 pt-1"}>
              ...
              <Dialog>
                <DialogTrigger color={"danger"} as={Button}>
                  删除
                </DialogTrigger>
                <DialogPortal>
                  <DialogBackdrop />
                  <DialogContent className="max-w-86 my-20">
                    <DialogClose
                      className={"absolute end-2 top-2 p-1"}
                      as={CloseButton}
                    />
  ...
  return (
    <div className={"flex flex-row items-center gap-5"}>
      ...
      <Dialog scrollBehavior={scrollBehavior}>
        ...
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-160 my-20 flex flex-col">
            <DialogClose
              className={"absolute end-2 top-2 p-1"}
              as={CloseButton}
            />
          ...
          <DialogContent className="my-25 w-96">
            ...
            >
              <textarea
                ...
                required
                className={
                  "border-bd-normal w-full rounded-md border px-3 py-2"
                }
                placeholder={"有什么新想法吗?"}
