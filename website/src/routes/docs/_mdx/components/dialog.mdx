...
export default function App() {
  return (
    <Dialog>
      ...
      <DialogPortal>
        <DialogBackdrop />
        <DialogContent className="max-w-[calc(100vw-6rem) my-20 md:max-w-128">
          <DialogClose
...
export default function App() {
  return (
    <Dialog>
      ...
      <DialogPortal>
        <DialogBackdrop />
        <DialogContent className="max-w-[calc(100vw-6rem) my-25 md:max-w-128">
          <DialogClose
            className={"absolute end-2 top-2 p-1"}
            render={(props) => <CloseButton {...props} />}
          />
          ...
          <div className={"flex justify-end gap-4 p-4 pt-1"}>
            ...
            <Dialog>
              ...
              <DialogPortal>
                <DialogBackdrop />
                <DialogContent className="max-w-[calc(100vw-6rem) my-20 md:max-w-86">
                  <DialogClose
                    className={"absolute end-2 top-2 p-1"}
                    render={(props) => <CloseButton {...props} />}
                  />
  ...
  return (
    <div className={"flex flex-row items-center gap-5"}>
      ...
      <Dialog scrollBehavior={scrollBehavior}>
        ...
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-[calc(100vw-6rem) my-20 flex flex-col md:max-w-160">
            <DialogClose
              className={"absolute end-2 top-2 p-1"}
              render={(props) => <CloseButton {...props} />}
            />
