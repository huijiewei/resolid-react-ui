  ...
  return (
    <div className={"flex flex-row gap-3"}>
      <Dialog placement={"top"}>
        <DialogTrigger render={(props) => <Button {...props} />}>打开对话框(顶部)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
      ...
      <Dialog placement={"center"}>
        <DialogTrigger render={(props) => <Button {...props} />}>打开对话框(中间)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
      ...
      <Dialog placement={"bottom"}>
        <DialogTrigger render={(props) => <Button {...props} />}>打开对话框(底部)</DialogTrigger>
        <DialogPortal>
          <DialogBackdrop />
          <DialogContent className="max-w-128 my-20">
            <DialogClose
