    ...
    <div className={"flex flex-row gap-3"}>
      <DropdownMenu>
        ...
        <DropdownMenuContent className={"text-sm"}>
          <DropdownMenuItem>
            新标签页
            <span className={"ml-auto pl-5 text-xs tracking-widest text-fg-subtle"}>⌘+T</span>
          </DropdownMenuItem>
          <DropdownMenuItem>
            打开新窗口
            <span className={"ml-auto pl-5 text-xs tracking-widest text-fg-subtle"}>⌘+N</span>
          </DropdownMenuItem>
          ...
          <DropdownMenuItem>
            关闭窗口
            <span className={"ml-auto pl-5 text-xs tracking-widest text-fg-subtle"}>⇧+⌘+W</span>
          </DropdownMenuItem>
          <DropdownMenuItem>
            关闭标签页
            <span className={"ml-auto pl-5 text-xs tracking-widest text-fg-subtle"}>⌘+W</span>
