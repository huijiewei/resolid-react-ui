...
export default function App() {
  ...
  return (
    <div className={"flex flex-col gap-2"}>
      ...
      <Select value={value} onChange={setValue} collection={collection}>
        <SelectContent className={"p-1"}>
          <SelectList></SelectList>
        </SelectContent>
      </Select>
...
export default function App() {
  ...
  return (
    <div className={"flex gap-3"}>
      <Select defaultValue={"blueberry"} collection={collection}>
        <SelectContent className={"p-1"}>
          <SelectList></SelectList>
        </SelectContent>
      </Select>
      <Select multiple defaultValue={["apple", "pineapple"]} collection={collection}>
        <SelectContent className={"p-1"}>
          <SelectList></SelectList>
        </SelectContent>
      </Select>
...
export default function App() {
  ...
  return (
    <Select multiple collection={collection}>
      <SelectContent className={"p-1"}>
        <SelectList></SelectList>
      </SelectContent>
    </Select>
